...
# Home
&emsp;&emsp;Fei Ma is a Research Scientist and Graduate Supervisor at Guangdong Laboratory of Artificial Intelligence and Digital Economy (SZ)（人工智能与数字经济广东省实验室（深圳））, also known as the Guangming Laboratory（光明实验室）, where he leads the Multimedia (MM) Group under the guidance of Prof. [Qi Tian](https://www.qitian1987.com/index.html)(Fellow of IEEE, ACM, AAAI, CAAI, CCF; IEAS Academician). His team focuses on <strong>human-centered multimodal content understanding and generation</strong>, with research spanning multimodal large language models, agents, AIGC, world models, and affective computing.
